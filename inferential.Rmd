...
We then render all those models into one figure where we can show statistical signifance and that results do not vary over all those scenarios.
...
We also average all 172 network size scenarios within respondents and run one single regression model so as to generate a table with coefficients.
